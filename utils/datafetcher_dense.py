...
class DataFetcher(threading.Thread):
    def __init__(self, mode, batch_size = 32, epoch = 10):
        ...
        if self.mode == 'train':
            ...
            self.image_path = '/media/tree/backup/projects/AttentionBased/data/train/point_{}_12'.format(1024)
            self.point_path = '/media/tree/backup/projects/AttentionBased/data/train/point_{}_12'.format(16384)
            ...
            self.image_path = '/media/tree/backup/projects/AttentionBased/data/test/point_{}_12'.format(1024)
            self.point_path = '/media/tree/backup/projects/AttentionBased/data/test/point_{}_12'.format(16384)
    ...
    def calculate_cat_batch_number(self):
        ...
        for cat in cats:
            with h5py.File(os.path.join(self.image_path, '{}.h5'.format(cat)), 'r') as f:
                batch_number = f['point'].shape[0] / self.batch_size
    ...
    def run(self):
        if self.mode == 'train':
            ...
            cat = shapenet_category_to_id['airplane']
